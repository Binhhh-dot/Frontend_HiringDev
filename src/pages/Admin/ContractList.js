        ...
        <div>
          ...
          <CardBody className="px-0">
            <TabContent activeTab={activeTab}>
              <TabPane tabId="1">
                {contractListAll.map((contractListAllNew, key) => (
                  <div
                    key={key}
                      ...
                      <Row className="align-items-center ">
                        ...
                        <Col md={2}>
                          <div className="d-flex flex-column gap-1 justify-content-center">
                            <div>
                              <p className="text-muted mb-0 fs-13">Create at</p>
                              <p
                        ...
                        <Col md={2} className="d-flex justify-content-center">
                          <div>
                            <p className="text-muted mb-0 fs-13">Date signed</p>
                            <p
                              className="mb-0 fs-17"
                              style={{ fontWeight: "600" }}
                            >
                        ...
                        <Col md={2} className="d-flex justify-content-center">
                          <div className="d-flex align-items-center">
                            <span
                              className={
                                contractListAllNew.statusString === "Pending"
                                  ? "badge bg-warning text-light fs-12"
                                  : contractListAllNew.statusString === "Signed"
                                  ? "badge bg-success text-light fs-12"
                                  : contractListAllNew.statusString === "Failed"
              ...
              <TabPane tabId="2">
                {contractListPending.map((contractListAllNew, key) => (
                  <div
                    key={key}
                    className="job-box-dev-in-list-hiringRequest-for-dev card mt-3"
                    style={{
                    ...
                    <CardBody className="p-2">
                      <Row className="align-items-center ">
                        ...
                        <Col md={2}>
                          <div className="d-flex flex-column gap-1 justify-content-center">
                            <div>
                              <p className="text-muted mb-0 fs-11">Create at</p>
                              <p
                                className="mb-0 fs-17"
                                style={{ fontWeight: "600" }}
                              >
                        ...
                        <Col md={2} className="d-flex justify-content-center">
                          <div>
                            <p className="text-muted mb-0 fs-11">Date signed</p>
                            <p
                              className="mb-0 fs-17"
                              style={{ fontWeight: "600" }}
                            >
              ...
              <TabPane tabId="3">
                {contractListSigned.map((contractListAllNew, key) => (
                  <div
                    key={key}
                    className="job-box-dev-in-list-hiringRequest-for-dev card mt-3"
                    style={{
                  ...
                  <Col lg={12} className="mt-4 pt-2">
                    <nav aria-label="Page navigation example">
                      <div className="pagination job-pagination mb-0 justify-content-center">
                        ...
                        <li
                          className={`page-item ${
                            currentPageSigned === totalPagesSigned
                              ? "disabled"
                              : ""
                          }`}
                        >
              ...
              <TabPane tabId="4">
                {contractListFailed.map((contractListAllNew, key) => (
                  <div
                    key={key}
                    className="job-box-dev-in-list-hiringRequest-for-dev card mt-3"
                    style={{
                  ...
                  <Col lg={12} className="mt-4 pt-2">
                    <nav aria-label="Page navigation example">
                      <div className="pagination job-pagination mb-0 justify-content-center">
                        ...
                        <li
                          className={`page-item ${
                            currentPageFailed === totalPagesFailed
                              ? "disabled"
                              : ""
                          }`}
                        >
