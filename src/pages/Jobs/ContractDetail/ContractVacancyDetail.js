...
const ContractVacancyDetail = () => {
    ...
    const fetchPreContract = async () => {
        let response;
        const contractIdState = location.state?.contractId;

        try {
            response = await contractServices.getContractById(
                contractIdState
            );
                        ...
                        <div id="pdf-content" className="">
                            ...
                            <div className="d-flex flex-column gap-3 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-12 d-flex align-items-center">
                                        <div className="mb-0">
                                            Legal Representative: {preContractInfo.legalRepresentation}
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 d-flex align-items-center">
                                        <div className="mb-0">
                                            Position: {preContractInfo.legalRepresentationPosition}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="d-flex flex-column gap-3">
                                ...
                                <div class="row">
                                    <div class="col-md-12 d-flex align-items-center">
                                        <div className="mb-0">
                                            (e) Start date of the Laborers: {preContractInfo.fromDate}
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 d-flex align-items-center">
                                        <div className="mb-0">
                                            (f) End date of the Laborers: {preContractInfo.toDate}
                                        </div>
                                    </div>
                                </div>
...
export default ContractVacancyDetail;
