...
const TransactionVacancyList = (a) => {
    ...
    const fetchJobVacancies = async () => {
        ...
        try {
            ...
            response = await transactionHistoryServices.getTransactionByCompanyIdAndPaging(companyId, currentPage, pageSize, inputSearch, status, "")
                ;
    ...
    const midleSelect = (transaction) => {
        setSelectReportDetail(transaction)
        setShowPopup(true);
    };
                                ...
                                <Form action="#" className="auth-form mt-2">
                                    <FormGroup className="mb-3">
                                        ...
                                        <Input
                                            ...
                                            readOnly={true}
                                            value={selectReportDetail.payPalTransactionId}
                                        />
                                    </FormGroup>
                                    <FormGroup className="mb-3">
                                        <Label
                                        ...
                                        <Input
                                            ...
                                            readOnly={true}
                                            value={selectReportDetail.payForMonth}
                                        />
                                    </FormGroup>
                                    <FormGroup className="mb-3">
                                        <Label
                                        ...
                                        <Input
                                            ...
                                            readOnly={true}
                                            value={selectReportDetail.paymentMethod}
                                        />
                                    </FormGroup>
                                    <FormGroup className="mb-3">
                                        <Label
                                        ...
                                        <Input
                                            ...
                                            readOnly={true}
                                            value={selectReportDetail.amount}
                                        />
                                    </FormGroup>
                                    <FormGroup className="mb-3">
                                        <Label
                                        ...
                                        <Input
                                            ...
                                            readOnly={true}
                                            value={selectReportDetail.description}
                                        />
                                    </FormGroup>
                                </Form>
                            </Col>
...
export default TransactionVacancyList;
